...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_io_expr_list = 58,              /* io_expr_list  */
  YYSYMBOL_io_expr = 59,                   /* io_expr  */
  YYSYMBOL_expression = 60,                /* expression  */
  YYSYMBOL_comparison_expr = 61,           /* comparison_expr  */
...
#line 1243 "syntaxic.tab.c"
    break;

  case 4: /* type: FLOAT  */
#line 68 "syntaxic.y"
            {strcpy(sauvType,"FLOAT");}
#line 1249 "syntaxic.tab.c"
    break;

  case 5: /* type: CHAR  */
#line 69 "syntaxic.y"
            {strcpy(sauvType,"CHAR");}
#line 1255 "syntaxic.tab.c"
    break;
