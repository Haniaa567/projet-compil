...
#line 751 "syntaxic.y"
=======
  case 81: /* AND_EXPR: LPAREN COND RPAREN  */
#line 724 "syntaxic.y"
...
#line 2214 "syntaxic.tab.c"
  ...
  case 84: /* NOT_EXPR: LPAREN comparison_expr RPAREN  */
#line 739 "syntaxic.y"
                                  { (yyval.string) = (yyvsp[-1].string);  }
